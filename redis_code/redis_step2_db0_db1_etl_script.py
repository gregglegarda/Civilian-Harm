...
source_redis = redis.StrictRedis(host='localhost', port=6379, db=0)  # Source database (db0)
target_redis = redis.StrictRedis(host='localhost', port=6379, db=1)  # Target database (db1)
